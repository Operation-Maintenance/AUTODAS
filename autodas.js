...
(function () {
    ...
    window.addEventListener('load', function () {
      ...
      setTimeout(function () { // récuparation des data nécéssaire
        const idDas = document.getElementById('application-AccessManagement-Display-component---accessManagementPhase--accessmanagement_01_01_01-defaultXML--externalCode-inner').value;
    ...
    function sendEmail(idElement, idDas, idSociete, idAdresse, idLieux, idInter, idSpec, idDesc, contact, idIFSpec, idDatedebut, idDatefin, choix2) {
      ...
      var subject = choix2 + ' Intervention sur les antennes FREE MOBILE,' + idElement + " // " + idDas; // sujet du mail
      var body = 'Bonjour,\n\nNous sommes la société CELLNEX France mandatée par l\'antenniste FREE. \n';
      body += 'Nous vous informons que la société ' + idSociete + ' souhaite intervenir sur votre site situé au ' + idAdresse + ' le ' + idDatedebut + ' jusqu\'au ' + idDatefin + '. \n'; //corps du mail
      body += 'Ci-dessous les informations concernant l’opération :\n';
      body += 'Référence du site : ' + idElement + ' // ' + idDas + '.\n';
      body += 'Lieu de l\'intervention : ' + idLieux + '.\n';
      body += 'Nature d\'intervention :' + idInter + '.\n';
      body += 'Sur les équipements de l\’opérateur : Cellnex France.';
      body += '\nEquipements spéciaux : ' + idIFSpec + " " + idSpec;
      body += '\nMotif de l’intervention : ' + idDesc;
      body += '\nLes Intervenants sont : \n';
      for (var i = 0; i < contact.length; i++) {
        body += contact[i] + "\n";
      }
      body += '\nAvons-nous votre accord pour l’intervention ? \n';
      body += 'Dans l’attente de votre retour.\n';
      body += '\nCordialement,';
      body += '\nGACX - Guichet Accès Cellnex\n';
      body += '\nRetrouvez-nous du lundi au vendredi de 8h00 à 18h00, hors jours fériés.';
      body += '\nTéléphone : 0 800 94 10 99 (option 2, choix 1) \n Cellnex Telecom\n';
